...
def calc_dist(p_curr, p_rot, foe, tZ):
    ...
    #return (tZ * (foe[0] - p_rot[0]) / (p_curr[0] - p_rot[0])+(tZ * (foe[1] - p_rot[1]) / (p_curr[1] - p_rot[1]))*(1/2))
    m, n = epipolar_line(p_curr, foe)
    return ((tZ * (foe[0] - p_rot[0])) / (p_curr[0] - p_rot[0])) / (abs(m) + 1) + (
    (tZ * (foe[1] - p_rot[1])) / (p_curr[1] - p_rot[1])) * (abs(m) / (abs(m) + 1))
    #return ((tZ * (foe[0] - p_rot[0])) / (p_curr[0] - p_rot[0]))
    ...
    #x_ratio = ((tZ * (foe[0] - p_rot[0])) + (p_curr[0] - p_rot[0]))
    #y_ratio = ((tZ * (foe[1] - p_rot[1])) + (p_curr[1] - p_rot[1]))
    #return ((tZ * (foe[0] - p_rot[0])) / (p_curr[0] - p_rot[0])) * (x_ratio / (x_ratio + y_ratio)) + (
            #(tZ * (foe[1] - p_rot[1])) / (p_curr[1] - p_rot[1])) * (y_ratio / (x_ratio + y_ratio))
